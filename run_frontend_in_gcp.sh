...
REGION=us-central1
ZONE=us-central1-c
PROJECT_NAME="project-371716"
IP_NAME="$PROJECT_NAME-ip"
GOOGLE_ACCOUNT_NAME="kathyagafonov" # without the @post.bgu.ac.il or @gmail.com part
...
gcloud compute scp gs://ir-kath-netanel-bucket-311206/search_frontend.py $GOOGLE_ACCOUNT_NAME@$INSTANCE_NAME:/home/$GOOGLE_ACCOUNT_NAME
